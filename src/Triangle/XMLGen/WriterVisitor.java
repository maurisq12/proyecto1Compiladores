...
public class WriterVisitor implements Visitor {
    ...
    private void writeLineXML(String line) {
        try {
            ...
            System.err.println("Error while writing the XML line");
            e.printStackTrace();
        }
    }
    ...
    public Object visitRepeatCommand(RepeatCommand aThis, Object o) {
        writeLineXML("<RepeatCommand>");
        aThis.rb.visit(this, null);
        writeLineXML("</RepeatCommand>");
        return null;
    }
